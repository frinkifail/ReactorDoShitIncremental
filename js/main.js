...
function update() {
    ...
    if (data.simulons >= data.generators[1].cost) {document.getElementById("generator1 button").classList = ['generators-buttons', 'canPurchase']} else {document.getElementById("generator1 button").className = 'generators-buttons cantPurchase'}
